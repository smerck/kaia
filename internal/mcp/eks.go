...
func (c *EKSClient) GetClusterInfo(_ context.Context, clusterName string) (string, error) {
...
func (c *EKSClient) GetPodStatus(_ context.Context, clusterName string) (string, error) {
	// TODO: Implement actual MCP server call
	// For now, return stub data
	return fmt.Sprintf("Pods in cluster %s:\n- nginx-deployment-abc123: Running\n- redis-deployment-def456: Running\n- app-deployment-ghi789: Pending",
		clusterName), nil
}
